...
class CardServiceIntegrationTest {
    ...
    void charge_validAmount_chargeSuccess(int amount) {
        ...
        //when
        CardChargeResponse chargeResponse = cardService.charge(savedUser.getId(), cardChargeRequest);
    ...
    void charge_invalidAmount_exceptionThrown(int amount) {
        ...
        //when
        assertThrows(IllegalArgumentException.class, () -> cardService.charge(savedUser.getId(), cardChargeRequest));
    }
}